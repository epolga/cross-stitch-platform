...
| 2026-08-06 | "The tin I inherited from Milena" — blog teaser for `/short-stories#milenas-tin`. | Sent via `UploaderCli send-announcement`: 733 recipients, `eid=260806`, 13:09 UTC (16:09 Israel time) — matches the planned ~16:00 window. Log: `uploader/UploaderCli/send-log-announcement.jsonl`. Not yet checked via GA4/SES (see Focus.md Open items). |

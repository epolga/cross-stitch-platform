...
const STATIC_PAGE_LASTMOD: Record<string, string> = {
  '/': '2026-08-23', // src/app/page.tsx
  '/XStitch-Charts.aspx': '2026-08-23', // src/app/[slug]/page.tsx (shared catch-all)
  '/photo-to-cross-stitch': '2026-09-03', // src/app/photo-to-cross-stitch/page.tsx

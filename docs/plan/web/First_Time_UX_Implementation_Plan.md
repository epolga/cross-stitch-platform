...
- [x] Step 5: "Open in Editor" button on design pages, event tracked — already implemented
- [x] Step 6: "Create your own pattern" CTA on album pages, event tracked — already implemented
